...
# 프로젝트 루트를 path에 추가 (app 모듈 import 위해)
...
from app.closet.gemini_client import GeminiImageAnalyzer  # noqa: E402
from app.closet.schemas import (  # noqa: E402
    ExtraAttributes,
    ExtraMetadata,
    MajorAttributes,
)
from app.config import get_settings  # noqa: E402
from app.embedding.client import UpstageEmbeddingClient  # noqa: E402
from app.embedding.formatter import HybridFormatter  # noqa: E402
...
async def process_single_product(
    ...
    upsert_to_qdrant(qdrant, collection, product["productId"], vector, payload)
